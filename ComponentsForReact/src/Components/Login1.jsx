...
const Login1 = () => {
  ...
  return (
    <>
      <div  className=' main m-10 overflow-hidden'>
        <div className='flex bg-gradient-to-r from-[#391d59] to-[#391d59] max-w-2xl justify-between relative overflow-hidden'>
            ...
            <div className="flex items-center justify-center">
              <div className="w-full max-w-md p-8 rounded-lg">
                ...
                <form onSubmit={handleLogin}>
                  ...
                  <div className="mb-4">
                    <label htmlFor="email" className="block text-[#e8e3cc] font-medium mb-2">Email:</label>
                    <input
                      type="email"
                      id="email"
                      value={email}
                  ...
                  <div className="mb-6">
                    <label htmlFor="password" className="block text-[#e8e3cc] font-medium mb-2">Password:</label>
                    <input
                      type="password"
                      id="password"
                      value={password}
                ...
                <p className="text-center mt-4 text-[#e8e3cc]">
                  Don't have an account? <a onClick={slideAnimation2} className="text-white hover:underline">Sign up here</a>
                </p>
              </div>
            </div>
          </div>
          ...
          <div className='right relative z-[3]'>
            <div className="flex items-center justify-center">
              <div className="w-full max-w-md p-8 rounded-lg">
                ...
                <form onSubmit={handleLogin}>
                <div className="mb-4">
                    <label htmlFor="fullName" className="block text-[#e8e3cc] font-medium mb-2">Full Name:</label>
                    <input
                      type="text"
                      id="fullName"
                      value={fullName}
                ...
                <p className="text-center mt-4 text-[#e8e3cc]">
                  Already have an account? <a onClick={slideAnimation}  className="text-white hover:underline">Login here</a>
                </p>
              </div>
            </div>
          </div>
          ...
          <div ref={gsapRef} className=' absolute top-0 left-0 w-1/2 h-full bg-[#391d59] z-[4] '>
            <div ref={circleRef} className='w-[32rem]  h-[32rem] rounded-[50%] bg-[#e8e3cc] -translate-x-48 -translate-y-10 opacity-100 absolute'>
              <div ref={innerTextRef}  className='relative flex flex-col justify-center items-center translate-y-24 translate-x-16 mt-8'>
                <div className='w-32 h-32 bg-black rounded-full overflow-hidden'>
                    <img src="https://res.cloudinary.com/dhhvmkyjz/image/upload/v1727075278/uszrujwkgsitjzlgiwzs.png" alt="" />
                </div>
                <div className=' flex flex-col translate-x-0 items-center '>
                  <h1 className='text-2xl font-bold text-black'>Aurrna</h1>
                   <h1 className='text-xl font-semibold text-black translate-x-4'>Your Jewellery Destination</h1>
